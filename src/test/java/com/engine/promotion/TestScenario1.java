...
public class TestScenario1 {
    ...
    private static String testScenario1 = "{\n" +
            "    \"cart_id\" : 1,\n" +
            "    \"order_details\" : [\n" +
            "        {\n" +
            "            \"sku_id\" : 1,\n" +
    ...
    private static String promotionConfigJson1 = "{\n" +
            "  \"name\" : \"C_D_COMBO\",\n" +
            "  \"type\" : \"COMBO_PROMO\",\n" +
            "  \"id\" : 1,\n" +
            "  \"isActive\" : true,\n" +
    ...
    public static List<PromotionConfig> getNthConfigScenario1() throws JsonProcessingException {
    ...
    public static List<PromotionConfig> getPromotionConfigScenario1() throws JsonProcessingException {
       return Arrays.asList((PromotionConfig) objectMapper.readValue(promotionConfigJson1, ComboPromotionConfig.class));
    }
    public static RequestOrderSKUs getRequestScenario1() throws JsonProcessingException {
        RequestOrderSKUs requestOrderSKUs = objectMapper.readValue(testScenario1, RequestOrderSKUs.class);
