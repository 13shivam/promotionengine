...
public class TestScenario3 {
    ...
    private static String testScenario3 = "{\n" +
            "  \"cart_id\" : 1,\n" +
            "  \"order_details\" : [ {\n" +
            "    \"sku_id\" : 1,\n" +
            "    \"quantity\" : 3\n" +
    ...
    private static String promotionConfigJson3 = "{\n" +
            "  \"name\" : \"C_D_COMBO\",\n" +
            "  \"type\" : \"COMBO_PROMO\",\n" +
            "  \"id\" : 1,\n" +
            "  \"isActive\" : true,\n" +
    ...
    public static List<PromotionConfig> getNthConfigScenario3() throws JsonProcessingException {
    ...
    public static List<PromotionConfig> getPromotionConfigScenario3() throws JsonProcessingException {
        return Arrays.asList((PromotionConfig) objectMapper.readValue(promotionConfigJson3, ComboPromotionConfig.class));
    }

    public static RequestOrderSKUs getRequestScenario3() throws JsonProcessingException {
        RequestOrderSKUs requestOrderSKUs = objectMapper.readValue(testScenario3, RequestOrderSKUs.class);
